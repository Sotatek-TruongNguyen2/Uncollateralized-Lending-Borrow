...
| Name | Type | Description |
|---|---|---|
| pool | contract IOvenueJuniorPool | The tranched pool to invest into (as the senior) |

#### Returns

| Name | Type | Description |
|---|---|---|
| _0 | uint256 | The amount of money to invest into the tranched pool&#39;s senior tranche, from the senior pool |
...
```solidity
function invest(contract IOvenueJuniorPool pool) external view returns (uint256)
```
