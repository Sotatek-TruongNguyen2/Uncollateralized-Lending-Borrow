...
contract CreditLine is BaseUpgradeablePausable, IOvenueCreditLine {
    ...
    )
  {
    ...
    // console.log("===== START ASSESSING =====");
    // console.log("Time assess: ", currentTime(), nextDueTime);
    ...
    )
  {
    ...
    // console.log("owned: ", newInterestOwed, newPrincipalOwed);
    ...
    // console.log("balance: ", pa.interestPayment, totalPrincipalPayment, paymentRemaining);
